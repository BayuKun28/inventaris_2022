            ...
            <div class="row col-md-12">
                <div class="form-row">
                    <div class="box-header col-md-12">
                        <form method="post" action="<?= base_url('Laporan/Pengembaliankendaraan') ?>" class="row">
                            ...
                            <div class="form-group col-md-4 align-items-end">
                                ...
                                <a href="<?= base_url('Laporan/cetakpengembaliankendaraan?tglawal=') . $tanggalawal . '&tglakhir=' . $tanggalakhir; ?>" name="cetak" class="btn btn-danger btn-col-1" target="_blank" role="button" aria-disabled="true"><i class="fa fa-balance-scale fa-fw"></i>Cetak</a>
                            </div>
                        </form>
                    </div>
                </div>
