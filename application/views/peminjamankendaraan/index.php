            ...
            <div class="row col-md-12">
                <div class="form-row">
                    <div class="box-header col-md-6">
                        <h3 class="box-title"><a href="<?= base_url('Peminjamankendaraan/FormInput'); ?>" class="btn btn-block btn-success">Tambah</a></h3>
                    </div>
                </div>
            </div>
            <!-- /.box-header -->
...
<div class="modal fade" id="modal-kembali">
    <div class="modal-dialog">
        <form action="<?= base_url('Peminjamankendaraan/kembali'); ?>" method="POST" enctype="multipart/form-data">
